...
export function validateBookingForm(data) {
  ...
  if (data.fee !== undefined && data.fee !== '' && Number(data.fee) < 0) {
    errors.fee = 'O cachê deve ser um valor positivo.';
  }
